...
// var baseURL='http://106.75.101.90:1389/backend/'
...
function apiAxios (method, url, params) {
  ...
  let httpDefault = {
    headers:{
      Authorization: token,
      'Content-Type': 'application/x-www-form-urlencoded;charset=utf-8'  //   multipart/form-data application/x-www-form-urlencoded;charset=utf-8  text/plain
    },
    method: method,
    baseURL: baseURL,
    url: url,
...
function apiAxios2 (method, url,data, params) {
  let token = sessionStorage.getItem('logininfo')?JSON.parse(sessionStorage.getItem('logininfo')).token:'';
