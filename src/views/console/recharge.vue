<template>
  <div class="mytask-container">
    <div class="page-title">
      <div class="left"><i class="el-icon-bell" /> 充值申请</div>
    </div>
      ...
      <div class="item-content">
        <el-table
          ...
          <el-table-column label="操作" fixed="right" width="120">
            <template slot-scope="scope">
              <el-button type="primary" size="mini" @click="$router.push({name:'chargedetail',query:{id:scope.row.id}})">详情</el-button>
            </template>
          </el-table-column>
        </el-table>
        <el-pagination
...
export default {
  ...
  data() {
    return {
      ...
      tableData: [],
      stateCN:{0:'待付款',1:'确认付款 ',2:'确认到账',3:'超时',4:'后台失败'}
    }
  },
  watch: {
    state:function(val){
